...
# Create function to calculate the average of a list of numbers
...
def lambda_handler(event, context):
    ...
    # Iterate over the objects to get the relevant CSV files
    ...
    # Calculate the average for the extracted numbers
    if count > 0:
